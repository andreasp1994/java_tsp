...
public class SimulatedAnnealingTsp {
	...
	private static final double absolute_zero = 1;
 	private static final int acceptance_offset = 10000;
	...
	public static void main(String [] args)
	{
		...
		try {
	        ...
	        while(temp > absolute_zero){
	            ...
	            //Activate edge matching with roulette wheel selection when plateau is reached
	            if (best.getDistance() < 14000 && plateaucounter >= 5)
	            {
	            	plateaucounter = 0;
			        Edge edge = rouletteWheelSelection(edges, maxDistance, sumDistance);
			        //if (Math.random() < 0.5)
	            ...
	            //Keep track of the previous distance achieved
	            ...
	            System.out.println("Current distance:" + currentSolution.getDistance() );
...
//		
    ...
    private static double acceptanceProbability(double energy, double newEnergy, double temperature) {
        ...
        //if(temperature>100)
        	return Math.exp((energy - newEnergy) / (temperature/acceptance_offset));
        //else
