...
public class IntLinkedList {
    ...
    /** add node to front of list containing the int s */
    ...
    /**
     * Only to be called when list contains 1 element ( To be used in reverse )
     */
    public void fixTail(){
	...
	int i = 0;
	while (cursor != null){
		if (i == 0) sl.insert(cursor.getElement());
		else sl.addFront(cursor.getElement());
		i++;
		cursor = cursor.getNext();
	}
	return sl;
    ...
    // 
    // l.reverse() delivers a new IntLinkedList that has the 
